...
import { fetchCompetitions, fetchMatchDetail, fetchMatches, fetchTransfers, hasLiveApi, type ApiCompetition, type ApiMatch, type ApiMatchEvent, type ApiTransfer } from "./scoresApi";
